...
class DirectCollocation():
    def __init__(self, N: int, dynamics, N_states: int, N_controls: int, constraints: Callable[[np.ndarray,np.ndarray],np.ndarray], tolerance=1e-6):
        self.N = N
    ...
    def eq_constraints(self, variables):
        ...
        constraints[0] = states[0]-self.initial_state
        constraints[1] = states[-1]-self.final_state
